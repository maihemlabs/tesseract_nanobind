...
ModifyAllowedCollisionsType_ADD: ModifyAllowedCollisionsType = (
    ModifyAllowedCollisionsType.ADD
)

ModifyAllowedCollisionsType_REMOVE: ModifyAllowedCollisionsType = (
    ModifyAllowedCollisionsType.REMOVE
)
...
class ChangeCollisionMarginsCommand(Command):
    ...
    def __init__(
        self,
        pair_margin_data: tesseract_robotics.tesseract_common._tesseract_common.CollisionMarginPairData,
        override_type: tesseract_robotics.tesseract_common._tesseract_common.CollisionMarginPairOverrideType = tesseract_robotics.tesseract_common._tesseract_common.CollisionMarginPairOverrideType.REPLACE,
    ) -> None: ...
    def getDefaultCollisionMargin(self) -> float | None: ...
    def getCollisionMarginPairData(
        self,
    ) -> (
        tesseract_robotics.tesseract_common._tesseract_common.CollisionMarginPairData
    ): ...
    def getCollisionMarginPairOverrideType(
        self,
    ) -> (
        tesseract_robotics.tesseract_common._tesseract_common.CollisionMarginPairOverrideType
    ): ...
...
class Environment:
    ...
    def findTCPOffset(
        self,
        manip_info: tesseract_robotics.tesseract_common._tesseract_common.ManipulatorInfo,
    ) -> tesseract_robotics.tesseract_common._tesseract_common.Isometry3d: ...
    def getDiscreteContactManager(
        self,
    ) -> (
        tesseract_robotics.tesseract_collision._tesseract_collision.DiscreteContactManager
    ): ...
    def getContinuousContactManager(
        self,
    ) -> (
        tesseract_robotics.tesseract_collision._tesseract_collision.ContinuousContactManager
    ): ...
